...
const homepagePage = templateEngine.renderPage(homePage, { tabTitle: "Mandatory | Home",
cssLink: '<link rel="stylesheet" href="/assets/css/home.css">' });

const expresspage = templateEngine.readPage(`express/express.html`);
const expresspagePage = templateEngine.renderPage(expresspage, { tabTitle: "Mandatory | Express",
cssLink: '<link rel="stylesheet" href="/assets/css/express.css">' });

const restapi = templateEngine.readPage(`restapi/restapi.html`);
const restapiPage = templateEngine.renderPage(restapi, { tabTitle: "Mandatory | Rest API",
cssLink: '<link rel="stylesheet" href="/assets/css/express.css">' });

const javascript = templateEngine.readPage(`javascript/javascript.html`);
const javascriptPage = templateEngine.renderPage(javascript, { tabTitle: "Mandatory | JavaScript",
cssLink: '<link rel="stylesheet" href="/assets/css/express.css">' });

const terminal = templateEngine.readPage(`terminal/terminal.html`);
const terminalPage = templateEngine.renderPage(terminal, { tabTitle: "Mandatory | Terminal Commands",
cssLink: '<link rel="stylesheet" href="/assets/css/express.css">' });
...
const loginPage = templateEngine.renderPage(login, {tabTitle: "Mandatory | Login", 
